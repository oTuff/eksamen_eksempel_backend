...
class HarbourFacadeTest {
    ...
    public HarbourFacadeTest() throws ParseException {
    }
    ...
    @Test
    public void getAllHarbours() throws API_Exception {
        List<Harbour> actual = facade.getAllHarbours();
        int expected = 1;
        assertEquals(expected, actual.size());
    }

    @Test
    public void getAllBoatsByHarbour() throws API_Exception {
        List<Boat> actual = facade.getAllBoatsByHarbour(h1.getId());
        int expected = 1;
        assertEquals(expected, actual.size());
