...
class HarbourDTOFacadeTest {

    private static EntityManagerFactory emf;
    private static HarbourDTOFacade facade;
    ...
    public HarbourDTOFacadeTest() throws ParseException {
    }

    @BeforeAll
    public static void setUpClass() {
        emf = EMF_Creator.createEntityManagerFactoryForTest();
        facade = HarbourDTOFacade.getInstance(emf);
    }
    ...
    @Test
    void findAllHarbourDTOs() throws API_Exception {
        List<HarbourDTO> actual = facade.getAllHarbours();
        int expected = 1;
